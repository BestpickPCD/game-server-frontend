  ...
  [200],
  {
    9955: function (t, e, o) {
      ...
      var r = o(4942),
        ...
        p = o(1217);
      function b(t) {
        return (0, p.Z)('MuiSwitch', t);
      }
      var m = (0, h.Z)('MuiSwitch', [
          'root',
          'edgeStart',
          'edgeEnd',
          'switchBase',
        ...
        Z = o(184),
        w = ['className', 'color', 'edge', 'size', 'sx'],
        g = (0, v.ZP)('span', {
          name: 'MuiSwitch',
          slot: 'Root',
        ...
        S = (0, v.ZP)(u.Z, {
          ...
          function (t) {
            ...
            return (
              ...
              (0, r.Z)(e, '&.'.concat(m.checked), {
                transform: 'translateX(20px)'
              }),
              (0, r.Z)(e, '&.'.concat(m.disabled), {
                color: o.vars
              ...
              (0, r.Z)(e, '&.'.concat(m.checked, ' + .').concat(m.track), {
                opacity: 0.5
              }),
              (0, r.Z)(e, '&.'.concat(m.disabled, ' + .').concat(m.track), {
                opacity: o.vars
                  ? o.vars.opacity.switchTrackDisabled
                  : ''.concat('light' === o.palette.mode ? 0.12 : 0.2)
              }),
              (0, r.Z)(e, '& .'.concat(m.input), {
                left: '-100%',
                width: '300%'
              }),
              e
        ...
        C = a.forwardRef(function (t, e) {
          var o = (0, f.Z)({ props: t, name: 'MuiSwitch' }),
            ...
            m = o.sx,
            C = (0, n.Z)(o, w),
            B = (0, l.Z)({}, o, { color: s, edge: v, size: p }),
            k = (function (t) {
              var e = t.classes,
                o = t.edge,
                r = t.size,
            ...
            M = (0, Z.jsx)(y, { className: k.thumb, ownerState: B });
          return (0,
          Z.jsxs)(g, { className: (0, i.Z)(k.root, r), sx: m, ownerState: B, children: [(0, Z.jsx)(S, (0, l.Z)({ type: 'checkbox', icon: M, checkedIcon: M, ref: e, ownerState: B }, C, { classes: (0, l.Z)({}, k, { root: k.switchBase }) })), (0, Z.jsx)(x, { className: k.track, ownerState: B })] });
        });
    },
    3896: function (t, e, o) {
      o.d(e, {
          ...
          var Rt = c.useState(!1),
            ...
            re = (0, I.Z)(function () {
              if (Zt && !1 !== tt) {
                ...
                (t === At.start && e === At.end) || Ht({ start: t, end: e });
              }
            });
          c.useEffect(
            function () {
...
//# sourceMappingURL=200.ceec5db2.chunk.js.map
