  ...
  [917],
  {
    9419: function (e, n, r) {
      ...
      n.Z = function (e) {
        ...
        var H = (0, f.ev)({}, { refetchOnMountOrArgChange: !0 }).data,
          V = (0, m.useMemo)(
            function () {
              var e;
              return null === H ||
    ...
    1917: function (e, n, r) {
      ...
      var t = r(4942),
        ...
        C = r(184),
        R = A.Ry().shape({
          name: A.Z_().required('Last name is required!'),
          email: A.Z_().required('Email is required!'),
          roleId: A.Rx(),
          currencyId: A.Rx().required('Currency is required!'),
          isActive: A.O7(),
          username: A.Z_().required('Username is required!'),
          parentAgentId: A.Z_().nullable()
        }),
        k = function (e) {
          var n = e.open,
            r = e.detail,
            ...
            (0, o.useEffect)(
              function () {
                A &&
                  T(function (e) {
                    return (0,
                    s.Z)((0, s.Z)({}, e), {}, { userId: null === A || void 0 === A ? void 0 : A.id, amount: Number(e.amount) });
                  });
              },
              [A]
            );
...
//# sourceMappingURL=917.a80abbe4.chunk.js.map
