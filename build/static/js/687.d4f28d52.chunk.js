      ...
      const s = (e) =>
        ...
        d = (e) => {
          ...
          const { data: f, isFetching: k } = (0, i.aN)(
            { size: x.size, page: x.page, search: x.search, id: 1 },
          ...
          function w(e) {
            ...
            if (
              ...
              return p((e) => ({ ...e, page: x.page + 1 }));
          }
          (0, a.useEffect)(() => {
            p({ search: j || '', id: 1, totalItems: 0, page: 0, size: 20 }),
              Z([]);
          }, [j, d]),
            (0, a.useEffect)(
              () =>
      ...
      const L = {
        ...
        U = () => {
          const e = [
            ...
            { tableBody: u, tableHeader: h, tableFilter: x } = H(),
            [p, m] = (0, a.useState)([]),
            [g, j] = (0, a.useState)(),
            [Z, b] = (0, a.useState)({
              page: 0,
...
//# sourceMappingURL=687.d4f28d52.chunk.js.map
