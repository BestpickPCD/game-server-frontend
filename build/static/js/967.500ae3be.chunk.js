                  ...
                  (0, o.Z)(
                    {
                      ...
                      required: !0,
                      error: !!W.limit,
                      helperText: W.limit ? W.limit.message : '',
                      autoComplete: 'off'
                    },
                    E('limit')
                  )
              ...
              return [
                (0, P.jsxs)(B.Z, {
                  ...
                  children: [
                    (0, P.jsx)(O.Z, {
                      id: 'isActive',
                      children: (0, P.jsx)(R.Z, { id: 'label.type' })
                    }),
                    (0, P.jsxs)(y.Z, {
                      labelId: 'isActive',
                      value: n.value,
                      ...
                      children: [
                        (0, P.jsx)(k.Z, {
                          value: '',
                          children: (0, P.jsx)('em', {
                            children: (0, P.jsx)(R.Z, { id: 'label.default' })
                          })
                        }),
                        (0, P.jsx)(k.Z, {
                          value: 'all',
                          children: (0, P.jsx)(R.Z, { id: 'label.all' })
                        }),
                        (0, P.jsx)(k.Z, {
                          value: 'vendor',
                          children: (0, P.jsx)(R.Z, { id: 'label.vendor' })
                        }),
                        (0, P.jsx)(k.Z, {
                          value: 'game',
                          children: (0, P.jsx)(R.Z, { id: 'label.game' })
                        }),
                        (0, P.jsx)(k.Z, {
                          value: 'type',
                          children: (0, P.jsx)(R.Z, { id: 'label.type' })
                    ...
                    function (e) {
                      for (;;)
                        switch ((e.prev = e.next)) {
                          ...
                          case 3:
                            I({ message: B.DELETED }), xe(), (e.next = 10);
                            break;
                          case 7:
                            (e.prev = 7),
                              (e.t0 = e.catch(0)),
                              I({ message: B.ERROR, type: 'error' });
                          case 10:
                          case 'end':
                            return e.stop();
                        }
...
//# sourceMappingURL=967.500ae3be.chunk.js.map
