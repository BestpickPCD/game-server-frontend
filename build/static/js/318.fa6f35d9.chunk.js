  ...
  [318],
  {
    ...
    9891: function (e, t, o) {
      var a = o(4942),
        ...
        v = o(3785),
        m = o(184),
        f = ['className', 'color', 'edge', 'size', 'sx'],
        g = (0, h.ZP)('span', {
          name: 'MuiSwitch',
          slot: 'Root',
          overridesResolver: function (e, t) {
        ...
        Z = (0, h.ZP)(u.Z, {
          ...
          overridesResolver: function (e, t) {
            ...
            return [
              t.switchBase,
              (0, a.Z)({}, '& .'.concat(v.Z.input), t.input),
          ...
          function (e) {
            ...
            return (
              ...
              (0, a.Z)(t, '&.'.concat(v.Z.checked), {
                transform: 'translateX(20px)'
              }),
              (0, a.Z)(t, '&.'.concat(v.Z.disabled), {
                color: o.vars
              ...
              (0, a.Z)(t, '&.'.concat(v.Z.checked, ' + .').concat(v.Z.track), {
                opacity: 0.5
              }),
              (0, a.Z)(t, '&.'.concat(v.Z.disabled, ' + .').concat(v.Z.track), {
                opacity: o.vars
                  ? o.vars.opacity.switchTrackDisabled
                  : ''.concat('light' === o.palette.mode ? 0.12 : 0.2)
              }),
              (0, a.Z)(t, '& .'.concat(v.Z.input), {
                left: '-100%',
                width: '300%'
              }),
              t
        ...
        x = c.forwardRef(function (e, t) {
          var o = (0, p.Z)({ props: e, name: 'MuiSwitch' }),
            ...
            y = o.sx,
            S = (0, r.Z)(o, f),
            C = (0, n.Z)({}, o, { color: l, edge: h, size: k }),
            R = (function (e) {
              var t = e.classes,
                o = e.edge,
                a = e.size,
            ...
            z = (0, m.jsx)(w, { className: R.thumb, ownerState: C });
          return (0,
          m.jsxs)(g, { className: (0, i.Z)(R.root, a), sx: y, ownerState: C, children: [(0, m.jsx)(Z, (0, n.Z)({ type: 'checkbox', icon: z, checkedIcon: z, ref: t, ownerState: C }, S, { classes: (0, n.Z)({}, R, { root: R.switchBase }) })), (0, m.jsx)(b, { className: R.track, ownerState: C })] });
        });
      t.Z = x;
    },
    3785: function (e, t, o) {
      ...
      var a = o(5878),
        r = o(1217);
      function n(e) {
        return (0, r.Z)('MuiSwitch', e);
      }
      var c = (0, a.Z)('MuiSwitch', [
        'root',
        'edgeStart',
        'edgeEnd',
        'switchBase',
...
//# sourceMappingURL=318.fa6f35d9.chunk.js.map
