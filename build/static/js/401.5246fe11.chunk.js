  ...
  [401],
  {
      ...
      const o = (e) =>
        ...
        d = (e) => {
          ...
          const [h, x] = (0, a.useState)({
            ...
            v = (0, l.Z)(p, 500),
            [Z, j] = (0, a.useState)([]),
            [f, P] = (0, a.useState)({ id: '', name: '', value: '' });
          (0, a.useEffect)(() => {
            g(v), x((e) => ({ ...e, search: v }));
          }, [v]);
          const { data: b, isFetching: w } = (0, t.aN)(
          ...
          function S(e) {
            ...
            if (
              ...
              (b.data.page + 1) * b.data.size < b.data.totalItems
            )
              return x((e) => ({ ...e, page: h.page + 1 }));
          }
          (0, a.useEffect)(() => {
            x({ search: v || '', id: 1, totalItems: 0, page: 0, size: 20 }),
              j([]);
          }, [v, d]),
            (0, a.useEffect)(
              () =>
                j(
                  d
                    ...
                    : (e) => [
                        ...e,
                        ...o(null === b || void 0 === b ? void 0 : b.data.data)
                      ]
                ),
              [b, d]
            ),
    ...
    7590: (e, r, s) => {
      ...
      const v = (e) => {
        ...
        Z = (0, x.memo)(v),
        j = (e) => {
          let { label: r, name: s, errors: a, register: n, ...t } = e;
          return (0, g.jsx)(o.Z, {
            label: r,
            error: !!a[s],
            helperText: a[s] ? a[s].message : '',
            fullWidth: !0,
            ...n(s),
            ...t
          });
    ...
    9419: (e, r, s) => {
      ...
      const j = v.Ry().shape({
        ...
        f = (e) => {
          ...
          const [w, { isLoading: S }] = (0, x.l4)(),
            { notify: y, message: q } = (0, g.p)(),
            I = (0, m.s0)(),
            {
              register: T,
              handleSubmit: F,
          ...
          const { data: z } = (0, p.ev)({}, { refetchOnMountOrArgChange: !0 }),
            W = (0, o.useMemo)(() => {
              var e;
              return null === z ||
                void 0 === z ||
            ...
            E = async (e) => {
              try {
                const a = await w(e).unwrap();
                a &&
                  'CREATED' === a.message &&
                  (A(),
                  y({ message: 'Registered Successfully' }),
                  r || s ? (P(), b()) : I('/login'));
              } catch (a) {
                return 'DUPLICATE' === a.data.message
                  ? y({
                      message: 'Duplicated username or email',
                      type: 'error'
                    })
                  : y({ message: q.ERROR, type: 'error' });
              }
            };
          return (0, Z.jsxs)(t.Z, {
            component: 'form',
                ...
                children: [
                  (0, Z.jsx)(l.ZP, {
                    ...
                    children: (0, Z.jsx)(i.Z, {
                      ...
                      autoFocus: !0,
                      error: !!k.name,
                      helperText: k.name ? k.name.message : '',
                      ...T('name'),
                      onBlur: (e) => C('name', e.target.value.trim())
                    })
                  }),
                  (0, Z.jsx)(l.ZP, {
                    item: !0,
                        ...
                        !r &&
                          (0, Z.jsx)(l.ZP, {
                            ...
                            children: (0, Z.jsx)(i.Z, {
                              ...
                              autoFocus: !0,
                              error: !!k.rate,
                              helperText: k.rate ? k.rate.message : '',
                              ...T('rate'),
                              onBlur: (e) =>
                                C('rate', parseFloat(e.target.value.trim()))
                            })
                          })
                      ]
                    })
                      ...
                      children: [
                        (0, Z.jsx)(l.ZP, {
                          ...
                          children: (0, Z.jsx)(i.Z, {
                            ...
                            type: 'email',
                            error: !!k.email,
                            helperText: k.email ? k.email.message : '',
                            ...T('email'),
                            onBlur: (e) => C('email', e.target.value.trim())
                          })
                        }),
                        !r &&
                          (0, Z.jsx)(l.ZP, {
                  ...
                  (0, Z.jsx)(l.ZP, {
                    ...
                    children: (0, Z.jsx)(i.Z, {
                      ...
                      sx: { my: 1 },
                      error: !!k.username,
                      helperText: k.username ? k.username.message : '',
                      ...T('username'),
                      onBlur: (e) => C('username', e.target.value.trim())
                    })
                  }),
                  (0, Z.jsx)(l.ZP, {
                    item: !0,
                      ...
                      children: [
                        (0, Z.jsx)(l.ZP, {
                          ...
                          children: (0, Z.jsx)(i.Z, {
                            ...
                            type: 'password',
                            error: !!k.password,
                            helperText: k.password ? k.password.message : '',
                            ...T('password'),
                            onBlur: (e) => C('password', e.target.value.trim())
                          })
                        }),
                        (0, Z.jsx)(l.ZP, {
                          item: !0,
                          ...
                          children: (0, Z.jsx)(i.Z, {
                            ...
                            type: 'password',
                            error: !!k.confirmPassword,
                            helperText: k.confirmPassword
                              ? k.confirmPassword.message
                              : '',
                            ...T('confirmPassword'),
                            onBlur: (e) =>
                              C('confirmPassword', e.target.value.trim())
                          })
                        })
                      ]
                    })
